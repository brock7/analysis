...
function L1_1(A0_2)
  ...
  for _FORV_13_, _FORV_14_ in pairs(_UPVALUE0_) do
    if _FORV_13_ < os.time() - 2 then
      _UPVALUE0_[_FORV_13_] = nil
    elseif _FORV_13_ == os.time() and _FORV_14_ > GetHP() then
      _UPVALUE0_[_FORV_13_] = _FORV_14_
    end
  end
  if not _UPVALUE0_[os.time()] then
    _UPVALUE0_[os.time()] = GetHP()
  end
  if _UPVALUE0_[os.time() - 2] and _UPVALUE0_[os.time() - 2] - GetHP() > 110 then
    A0_2.Priority = 1
  end
end
UpdatePriority = L1_1
